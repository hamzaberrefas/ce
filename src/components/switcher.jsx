...
const uploader = Uploader({
  ...
  apiKey: 'public_kW15cFP3z8WCe5ScwZkqdEudVjGF'
});
...
const Switcher = ({ local_varaiable, ThemeChanger }) => {
  ...
  return (
    <Fragment>
            ...
            <div className="xl:col-span-12 col-span-12">
              <div className="box custom-box">
                ...
                <div className='flex grow justify-center items-center'>
                  <Link to="#" id="preview-btn" className=" ti-btn ti-btn-primary-full m-1" onClick={() => { }}>Preview</Link>
                  <Link to="#" id="save-btn" className=" ti-btn ti-btn-success-full m-1" onClick={() => { }}>Save</Link>
                </div>
              </div>
            </div>
          </div>
      ...
      <div id="hs-overlay-switcher" className="box hs-overlay m-4" tabIndex={-1}>
        <div className="box-body">
          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12 lg:col-span-6">
              <div className="box">
                <div className="box-header">
                  <h5 className="box-title">Logo Files (PNG/SVG):</h5>
                </div>
                <div className="box-body space-y-3">
                  <div>
                    <label htmlFor="small-file-input" className="sr-only">Logo (Bright Background)</label>
                  ...
                  <div>
                    <label htmlFor="file-input-medium" className="sr-only">Logo (Dark Background)</label>
                  ...
                  <div>
                    <label htmlFor="large-file-input" className="sr-only">Favicon</label>
            ...
            <div className="col-span-12 lg:col-span-6">
              <div className="box">
                <div className="box-header">
                  <h5 className="box-title">Background (Optional)</h5>
                </div>
          ...
          <div className="ti-offcanvas-body" id="switcher-body">
            ...
            <div>
              <span className='text-sm text-zinc-500'>Note: The following color option changes will appear on this page as a preview, these colors are for your store page and NOT the dashboard.</span>
            </div>
            <div id="switcher-2" className="" role="tabpanel" aria-labelledby="switcher-item-2">
              ...
              {/* <div className="menu-image theme-colors">
                ...
                <div className="flex switcher-style space-x-3 rtl:space-x-reverse flex-wrap gap-3">
                  <div className="ti-form-radio switch-select">
                    <input className="ti-form-radio bgimage-input bg-img1" type="radio" name="theme-images" id="switcher-bg-img" checked={local_varaiable.bgImg == 'bgimg1'} onChange={(_e) => { }} onClick={() => switcherdata.bgImage1(ThemeChanger)} />
                  </div>
                  <div className="ti-form-radio switch-select">
                    <input className="ti-form-radio bgimage-input bg-img2" type="radio" name="theme-images" id="switcher-bg-img1" checked={local_varaiable.bgImg == 'bgimg2'} onChange={(_e) => { }} onClick={() => switcherdata.bgImage2(ThemeChanger)} />
                  </div>
                  <div className="ti-form-radio switch-select">
                    <input className="ti-form-radio bgimage-input bg-img3" type="radio" name="theme-images" id="switcher-bg-img2" checked={local_varaiable.bgImg == 'bgimg3'} onChange={(_e) => { }} onClick={() => switcherdata.bgImage3(ThemeChanger)} />
                  </div>
                  <div className="ti-form-radio switch-select">
                    <input className="ti-form-radio bgimage-input bg-img4" type="radio" name="theme-images" id="switcher-bg-img3" checked={local_varaiable.bgImg == 'bgimg4'} onChange={(_e) => { }} onClick={() => switcherdata.bgImage4(ThemeChanger)} />
                  </div>
                  <div className="ti-form-radio switch-select">
                    <input className="ti-form-radio bgimage-input bg-img5" type="radio" name="theme-images" id="switcher-bg-img4" checked={local_varaiable.bgImg == 'bgimg5'} onChange={(_e) => { }} onClick={() => switcherdata.bgImage5(ThemeChanger)} />
                  </div>
                </div>
              </div> */}
            </div>
          ...
          <div className="ti-offcanvas-footer sm:flex justify-between">
            <Link to="#" id="reset-all" className=" ti-btn ti-btn-danger-full m-1" onClick={() => switcherdata.Reset(ThemeChanger)}>Reset</Link>
