...
import algeria from "../../../assets/images/flags/algerian_flag.jpg"
...
const Header = ({ local_varaiable, ThemeChanger }) => {
  ...
  const initialNotifications = [
    { id: 1, color: 'success', avatarColor: 'bg-success', icon: 'ti ti-user-check', text1: 'Account Notifications', text2: 'You have verified the admin account. He can now start selling!', class: '', class1: '' },
    { id: 1, color: 'cyan', avatarColor: 'bg-success', icon: 'ri-customer-service-2-fill', text1: 'Call Center Service', text2: 'Our team has successfully confirmed the orders', class: '', class1: '' },
    { id: 2, color: 'pink', avatarColor: 'bg-pink', icon: 'ti ti-discount-2', text1: 'Product Notifications', text2: "The product 'Trench 2' is out of stock", class: '', class1: '' },
    { id: 3, color: 'warning', avatarColor: 'bg-warning', icon: 'ti ti-clock', text1: 'Sales Notifications ', text2: "COSTUME 1' has 5 items left in stock. Time to restock!", class: 'text-warning', class1: ' ID: #1116773' },
    { id: 4, color: 'primary', avatarColor: 'bg-primary', icon: 'ti ti-gift', text1: 'Discount and Promotion Notifications', text2: "Discount code 'HIJAB20' has been used 23 times", class: '', class1: '' },
  ];
        ...
        <nav className="main-header !h-[3.75rem]" aria-label="Global">
          <div className="main-header-container ps-[0.725rem] pe-[1rem] ">
            ...
            <div className="header-content-left">
              ...
              <div className="lg:!hidden header-element md:px-[0.325rem] !items-center" onClick={() => toggleSidebar()}>
             ...
             rounded-full font-medium text-defaulttextcolor  transition-all text-xs dark:bg-bodybg dark:bg-bgdark dark:hover:bg-black/20 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
                            ...
                            <div className="pe-2">
                              <span
                                className={`inline-flex text-${notification.color} justify-center items-center !w-[2.5rem] !h-[2.5rem] !leading-[2.5rem] !text-[0.8rem] ${notification.avatarColor}/10 !rounded-[50%]`}><i
                                  className={`${notification.icon} text-[1.125rem]`}></i></span>
                            </div>
              ...
              <div className="header-element md:!px-[0.65rem] px-2 hs-dropdown !items-center ti-dropdown [--placement:bottom-left]">
                ...
                <button id="dropdown-profile" type="button"
                  ...
                  <img className="inline-block rounded-full " src={face11} width="32" height="32" alt="Image Description" />
                </button>
                <div className="md:block hidden dropdown-profile cursor-pointer">
                  <p className="font-semibold mb-0 leading-none text-[#536485] text-[0.813rem] ">RIWAM User</p>
                  <span className="opacity-[0.7] font-normal text-[#536485] block text-[0.6875rem] ">Freelancer</span>
                </div>
                <div
                  ...
                  <ul className="text-defaulttextcolor font-medium dark:text-[#8c9097] dark:text-white/50">
                    <li>
                      <Link className="w-full ti-dropdown-item !text-[0.8125rem] !gap-x-0  !p-[0.65rem] !inline-flex" to={`${import.meta.env.BASE_URL}profile/settings`}>
                        <i className="ti ti-settings text-[1.125rem] me-2 opacity-[0.7]"></i>Settings
                      </Link>
                    </li>
                    <li>
                      <Link className="w-full ti-dropdown-item !text-[0.8125rem] !gap-x-0  !p-[0.65rem] !inline-flex" to={`${import.meta.env.BASE_URL}profile/plan`}><i
                        className="ti ti-color-swatch text-[1.125rem] me-2 opacity-[0.7]"></i>Plan
                      </Link>
                    </li>
                    <li><Link className="w-full ti-dropdown-item !text-[0.8125rem] !gap-x-0 !p-[0.65rem] !inline-flex" to={`${import.meta.env.BASE_URL}profile/ContactUs`}><i
                      className="ti ti-help text-[1.125rem] me-2 opacity-[0.7]"></i>Contact Us</Link></li>
                    <li><Link className="w-full ti-dropdown-item !text-[0.8125rem] !gap-x-0 !p-[0.65rem] !inline-flex" to={`${import.meta.env.BASE_URL}`}><i
                      className="ti ti-login text-[1.125rem] me-2 opacity-[0.7]"></i>Log Out</Link></li>
