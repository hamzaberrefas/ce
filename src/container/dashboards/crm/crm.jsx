                    ...
                    <ul className="list-none crm-top-deals mb-0">
                      <li className="mb-[0.9rem]">
                        <div className="flex items-start flex-wrap">
                          ...
                          <div className="font-semibold text-[0.9375rem] ">200,893 DZD</div>
                        </div>
                      </li>
                      <li className="mb-[0.9rem]">
                        <div className="flex items-start flex-wrap">
                          ...
                          <div className="font-semibold text-[0.9375rem] ">400,289 DZD</div>
                        </div>
                      </li>
                      <li className="mb-[0.9rem]">
                        <div className="flex items-top flex-wrap">
                          ...
                          <div className="font-semibold text-[0.9375rem] ">610,347 DZD</div>
                        </div>
                      </li>
                      <li className="mb-[0.9rem]">
                        <div className="flex items-top flex-wrap">
                          ...
                          <div className="font-semibold text-[0.9375rem] ">320,894 DZD</div>
                        </div>
                      </li>
                      <li>
                        <div className="flex items-top flex-wrap">
                          ...
                          <div className="font-semibold text-[0.9375rem] ">200,679 DZD</div>
                        </div>
                      </li>
                    </ul>
                  </div>
