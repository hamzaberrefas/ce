...
import face11 from "../../src/assets/images/faces/9.jpg";
import dahabia from "../assets/images/ecommerce/dahabia-card.png";
import cpa from "../assets/images/ecommerce/cpa-card.png";



const Mailsettings = () => {
  const [selectedImage, setSelectedImage] = useState(face11); // Set the default image URL here
  ...
  return (
    <Fragment>
      <Pageheader currentpage="Settings" activepage="Email" mainpage="Settings" />
          ...
          <div className="box">
            <div className="box-header sm:flex block !justify-start">
              <nav aria-label="Tabs" className="md:flex block !justify-start whitespace-nowrap">
                ...
                <Link to="#" className="m-1 block w-full hs-tab-active:bg-primary/10 hs-tab-active:text-primary cursor-pointer text-defaulttextcolor dark:text-defaulttextcolor/70 py-2 px-3 text-[0.75rem] flex-grow font-medium rounded-md hover:text-primary " id="payment-item" data-hs-tab="#payment-settings" aria-controls="payment-settings">
                  Payment and billing
                </Link>
              ...
              <div className="tab-content">
                <div className="tab-pane show active" id="personal-info" aria-labelledby="Personal-item" >
                  <div className="sm:p-4 p-0">
                    ...
                    <div className="mb-6 flex max-md:flex-col gap-3 items-center">
                      <div className="mb-0">
                    ...
                    <div className="sm:grid grid-cols-12 gap-6 mb-6">
                      <div className="xl:col-span-6 col-span-12">
                        ...
                        <input type="text" className="form-control w-full !rounded-md" id="first-name" placeholder="Firt Name" value="RIWAM" />
                      </div>
                      <div className="xl:col-span-6 col-span-12">
                        <label htmlFor="last-name" className="form-label">Last Name</label>
                        <input type="text" className="form-control w-full !rounded-md" id="last-name" placeholder="Last Name" value="User" />
                      </div>
                      <div className="xl:col-span-12 col-span-12">
                        <label className="form-label">Email Address</label>
                        <div className="input-group mb-3">
                          <span className="input-group-text" id="basic-addon3">user@riwam.com</span>
                    ...
                    <div className="sm:grid grid-cols-12 gap-6 mb-6">
                      <div className="xl:col-span-6 col-span-12">
                        ...
                        <input type="text" className="form-control w-full !rounded-md" id="phone-number" placeholder="+213 123 456 789" value="+213612345678" />
                      </div>
                      <div className="xl:col-span-6 col-span-12">
                ...
                <div className="tab-pane hidden" id="account-settings" aria-labelledby="account-item" role="tabpanel">
                  <div className="grid grid-cols-12 gap-y-4 xl:gap-x-4">
                        ...
                        <div className="box-body">
                          ...
                          <div className="sm:flex block items-center mb-6 justify-between">
                            <div>
                              ...
                              <input type="text" className="form-control w-full !rounded-md" id="recovery-email" placeholder="recovery@riwam.com" />
                              <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mb-0">Incase of forgetting password, mails are sent to user@riwam.com</p>
                            </div>
                            {/* <div className="custom-toggle-switch sm:ms-2 ms-0">
                          ...
                          <div className="sm:flex block items-center mb-6 justify-between">
                            <div>
                              ...
                              <input type="text" className="form-control w-full !rounded-md" id="recovery-number" placeholder="+213 123 456 789" />
                              <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mb-0">SMS are sent to +213612345678 in case of recovery failure</p>
                            </div>
                            {/* <div className="custom-toggle-switch sm:ms-2 ms-0">
                      ...
                      <div className="box shadow-none mb-0 border dark:border-defaultborder/10">
                        <div className="box-header justify-between items-center sm:flex block">
                          ...
                          <div className="sm:mt-0">
                            <button type="button" className="ti-btn !py-1 !px-2 bg-primary text-white !text-[0.75rem] !font-medium">Sign out from all devices</button>
                          </div>
                        </div>
                        <div className="box-body">
                ...
                <div className="tab-pane hidden" id="payment-settings" aria-labelledby="payment-settings" role="tabpanel">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 py-8">
                    <div className="">
                      <h3 className='font-bold'>Credit card(s)</h3>
                      <p>Manage your credit cards and payment options.</p>
                      <button type="button" className="ti-btn ti-btn-primary-full !rounded-full mt-6" data-hs-overlay="#add-card-modal">Add new card</button>
                      <div id="add-card-modal" className="hs-overlay hidden ti-modal">
                        <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                          <div className="ti-modal-content">
                            <div className="ti-modal-header">
                              <h6 className="modal-title" id="staticBackdropLabel2">Add new card</h6>
                              <button type="button" className="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#add-card-modal">
                            ...
                            <div className="ti-modal-body">
                              <div className="flex flex-col gap-2">
                                <div>
                                  <label htmlFor="form-text" className="form-label !text-[.875rem] text-black">Full name</label>
                                  <input type="text" className="form-control" placeholder="RIWAM User" />
                                </div>
                                <div>
                                  <label htmlFor="form-text" className="form-label !text-[.875rem] text-black">Card number</label>
                                  <input type="text" className="form-control" placeholder="4811 3309 5863 4599" />
                                </div>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                  <div>
                                    <label htmlFor="form-text" className="form-label !text-[.875rem] text-black">Expiration date</label>
                                    <input type="text" className="form-control" placeholder="26/02" />
                                  </div>
                                  <div>
                                    <label htmlFor="form-text" className="form-label !text-[.875rem] text-black">Verification code</label>
                            ...
                            <div className="ti-modal-footer">
                              <button className="ti-btn ti-btn-primary-full" data-hs-overlay="#success-modal"
                      ...
                      <div id="success-modal" className="hs-overlay hidden ti-modal">
                        <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                          <div className="ti-modal-content">
                            <div className="ti-modal-header">
                              <h6 className="modal-title text-[1rem] font-semibold" id="mail-ComposeLabel">Credit card added successfully!</h6>
                              <button type="button" className="hs-dropdown-toggle !text-[1rem] !font-semibold !text-defaulttextcolor" data-hs-overlay="#success-modal"
                                data-hs-overlay-options='{ "isClosePrev": false }'>
                            ...
                            <div className="ti-modal-footer">
                              <button type="button"
                                ...
                                data-hs-overlay="#success-modal" data-hs-overlay-options='{ "isClosePrev": false }'>
                                Close
                              </button>
                            </div>
                          </div>
                    ...
                    <div className="flex flex-col gap-8">
                      <div className="flex items-center flex-wrap gap-2 border border-defaultborder dark:border-defaultborder/10 rounded-lg p-4">
                        <div className="sm:w-[65px]">
                          <img src={dahabia} className='img-fluid' />
                        </div>
                        <div>
                          <p className="font-semibold">DAHABIA ending with 0359</p>
                          <span className="text-[0.65rem]">Exp. date 02/26</span>
                        </div>
                      </div>
                      <div className="flex items-center flex-wrap gap-2 border dark:border-defaultborder/10 border-defaultborder rounded-lg p-4">
                        <div className="sm:w-[65px]">
                          <img src={cpa} className='img-fluid' />
                        </div>
                        <div>
                          <p className="font-semibold">CPA ending with 0468</p>
                          <span className="text-[0.65rem]">Exp. date 02/26</span>
                        </div>
                      </div>
                    </div>
                                            ...
                                            <li className="list-group-item !border-e-0 !border-s-0">
                                                <div className="grid grid-cols-12 gap-4">
                                                    ...
                                                    <div className="xl:col-span-4 col-span-12">
                                                        ...
                                                        <Select isMulti name="colors" options={Languageoptions} className="w-full !rounded-md"
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium  bg-primary text-white !rounded-e-none !border-e-0"
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-inboxmails" id="all-mails-inboxenable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium  bg-primary text-white !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-inboxmails" id="all-mails-inboxdisable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-sentmails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-sentmails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-draftsmails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-draftsmails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-spammails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-spammails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-importantmails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-importantmails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-trashmails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-trashmails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-archivemails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-archivemails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-starredmails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-starredmails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-settingsmails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-settingsmails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-mails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-mails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-homemails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-homemails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-workmails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-workmails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" className="btn-check" name="label-friendsmails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium text-white bg-primary !rounded-e-none !border-e-0"
                                                                    htmlFor="all-mails-enable">Enable</label>
                                                                <input type="radio" className="btn-check" name="label-friendsmails" id="all-mails-disable" />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none"
                                                                    htmlFor="all-mails-disable">Disable</label>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="grid grid-cols-12 xl:gap-x-[3rem] gap-y-4">
                                                    ...
                                                    <div className="xl:col-span-8 col-span-12">
                                                        <div className="sm:flex block items-center justify-between sm:mt-0 gap-x-4 mt-4">
                                                            <div className="mail-security-settings">
                                                                <p className="text-[0.875rem] mb-1 font-semibold">Minimum number of characters in the password</p>
                                                        ...
                                                        <div className="sm:flex block items-center justify-between gap-x-4 mt-4">
                                                            <div>
                                                                <p className="text-[0.875rem] mb-1 font-semibold">Maximum Password Length</p>
