                        ...
                        <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-6 sm:col-span-8 col-span-12">
                            <div className="box">
                                <div className="box-body !p-[3rem]">
                                    ...
                                    <p className="h5 font-semibold mb-2 text-center">Merci pour votre contribution ! </p>
                                    <p className="mb-4 text-[#8c9097] dark:text-white/50 opacity-[0.7] font-normal text-center">Le fournisseur proposé sera examiné dans les meilleurs délais.
                                        Ensemble, rendons le répertoire RFDZ encore plus complet !</p>
