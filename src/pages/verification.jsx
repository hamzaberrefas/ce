                ...
                <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-6 sm:col-span-8 col-span-12">
                    <div className="box">
                        ...
                        />
                            ...
                            <p className="h5 font-semibold mb-2 text-center">Formulaire de verification</p>
                            <p className="mb-4 text-[#8c9097] dark:text-white/50 opacity-[0.7] font-normal text-center">Veuillez compléter les informations demandées</p>
                            <div className="grid grid-cols-12 gap-y-4">
                                ...
                                <div className="xl:col-span-12 col-span-12">
                                    <label htmlFor="signup-lastname" className="form-label text-default">Votre email professionnel </label>
                                    <input type="text" className="form-control form-control-lg w-full !rounded-md"
                                        id="signup-lastname" placeholder="contact@riwam.com"/>
                                </div>
                                <div className="xl:col-span-12 col-span-12">
                                    <label htmlFor="signup-lastname" className="form-label text-default">Votre numéro de téléphone  </label>
                                    <input type="text" className="form-control form-control-lg w-full !rounded-md"
                                ...
                                {/*<div className="xl:col-span-12 col-span-12">
                                    <label htmlFor="signup-lastname" className="form-label text-default">Activité principale </label>
                                    <input type="text" className="form-control form-control-lg w-full !rounded-md"
                                        id="signup-lastname" placeholder="Commerce Electronique "/>
                                </div>
                                <div className="xl:col-span-12 col-span-12">
                                    <label htmlFor="signup-lastname" className="form-label text-default">Code d'Activité principale </label>
                                    <input type="text" className="form-control form-control-lg w-full !rounded-md"
                                        id="signup-lastname" placeholder="607074"/>
                                </div>
                                <div className="xl:col-span-12 col-span-12">
                                ...
                                {/*<div className="xl:col-span-12 col-span-12">
                                    <label htmlFor="signup-lastname" className="form-label text-default">Adresse complète </label>
                                    <input type="text" className="form-control form-control-lg w-full !rounded-md"
                                        id="signup-lastname" placeholder="Incubateur USTO-MB, Oran"/>
                                </div>
                                <div className="xl:col-span-12 col-span-12">
                                    <label htmlFor="signup-lastname" className="form-label text-default">Email professionnel </label>
                                    <input type="text" className="form-control form-control-lg w-full !rounded-md"
                                        id="signup-lastname" placeholder="contact@riwam.com"/>
                                </div>
                                <div className="xl:col-span-12 col-span-12">
                                    ...
                                    <div className="mt-4">
                                        <div className="form-check !flex !ps-0">
                                            ...
                                            <label className="ps-2 form-check-label text-[#8c9097] dark:text-white/50 font-normal block" htmlFor="defaultCheck1">
                                                ...
                                                className="text-success"><u> politique de confidentialité.</u></Link>  
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div className="xl:col-span-12 col-span-12 grid mt-2">
                                    <Link to={`${import.meta.env.BASE_URL}soumettre2`} className="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Soumettre ma demande </Link>
                                </div>
                            </div>
