                        ...
                        <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-6 sm:col-span-8 col-span-12">
                            <div className="box">
                                <div className="box-body !p-[3rem]">
                                    ...
                                    <p className="h5 font-semibold mb-2 text-center">Merci ! Votre demande a été envoyée avec succès.</p>
                                    <p className="mb-4 text-[#8c9097] dark:text-white/50 opacity-[0.7] font-normal text-center">Notre équipe vérifiera les informations et vous contactera si nécessaire.
                                        Vous recevrez un email de confirmation sous peu.</p>
