...
const Invoicelist = () => {
    return (
        <Fragment>
            <Pageheader currentpage="Order Tracking" activepage="Tracking" mainpage="Order Tracking" />
            <div className="grid grid-cols-12 gap-x-6">
                <div className="xl:col-span-9 col-span-12">
                    <div className="box">
                        <div className="box-header justify-between">
                            <div className="box-title">
                                Manage Order Trackings
                            </div>
                            <div className="flex">
                                <button type="button" className="ti-btn !py-1 !px-2 !text-[0.75rem] !text-white !font-medium bg-primary"><i className="ri-add-line font-semibold align-middle me-1"></i> New Tracking Code</button>
                                <div className="hs-dropdown ti-dropdown ms-2">
                                    ...
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" to="#">All Orders</Link></li>
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" to="#">Paid Orders</Link></li>
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" to="#">Pending Orders</Link></li>
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" to="#">Overdue Orders</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <table className="table whitespace-nowrap table-bordered min-w-full">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" className="text-start">Tracking ID</th>
                                        ...
                                        {Manageinvoicedata.map((idx) => (
                                            <tr className="invoice-list border border-defaultborder dark:border-defaultborder/10" key={Math.random()}>
                                                ...
                                                <td className='space-x-1 rtl:space-x-reverse'>
                                                    <button aria-label="button" type="button" className="ti-btn ti-btn-primary ti-btn-icon ti-btn-sm"><i className="ri-printer-line"></i></button>
                                                    <button aria-label="button" type="button" className="ti-btn ti-btn-danger ti-btn-icon ms-1 ti-btn-sm invoice-btn" ><i className="ri-delete-bin-5-line"></i></button>
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
                        ...
                        <div className="box-footer">
                            <nav aria-label="Page navigation">
                                <ul className="ti-pagination ltr:float-right rtl:float-left mb-0">
                                    ...
                                    <li className="page-item hidden sm:block"><Link className="page-link px-3 py-[0.375rem]" to="#">3</Link></li>
                        ...
                        <div className="box-body !p-0">
                            <div className="p-6 border-b border-dashed dark:border-defaultborder/10 flex items-start">
                                ...
                                <div className="flex-grow">
                                    <h6 className="mb-1 text-[0.75rem]">Total Orders Amount
                                    ...
                                    <div className="pb-0 mt-0">
                                        <div>
                                            <h4 className="text-[1.125rem] font-semibold mb-2">
                                                <CountUp className="count-up" end={192.87} />.87k DA
                                            </h4>
                            ...
                            <div className="p-6 border-b border-dashed dark:border-defaultborder/10 flex items-start">
                                ...
                                <div className="flex-grow">
                                    <h6 className="mb-1 text-[0.75rem]">Total Delivered Orders
                                    ...
                                    <div>
                                        <h4 className="text-[1.125rem] font-semibold mb-2">
                                            <CountUp className="count-up" end={168.83} />k DA
                                        </h4>
                                        <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
                            ...
                            <div className="flex items-start p-6 border-b dark:border-defaultborder/10 border-dashed">
                                ...
                                <div className="flex-grow">
                                    <h6 className="mb-1 text-[0.75rem]">Pending Orders
                                    ...
                                    <div>
                                        <h4 className="text-[1.125rem] font-semibold mb-2">
                                            <CountUp className="count-up" end={181.57} />k DA
                                        </h4>
                                        <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
                                            <span className="text-success me-1 font-semibold inline-flex">
                            ...
                            <div className="flex items-start p-6 border-b dark:border-defaultborder/10 border-dashed">
                                ...
                                <div className="flex-grow">
                                    <h6 className="mb-1 text-[0.75rem]">Overdue Orders
                                    ...
                                    <div>
                                        <h4 className="text-[1.125rem] font-semibold mb-2">
                                            <CountUp className="count-up" end={232.47} />k DA
                                        </h4>
                                        <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
                                            <span className="text-success me-1 font-semibold inline-flex">
                            ...
                            <div className="p-6">
                                <p className="text-[.9375rem] font-semibold">Tracking Stats <span className="text-[#8c9097] dark:text-white/50 font-normal">(Last 6 months) :</span></p>
