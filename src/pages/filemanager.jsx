...
import filemanager2 from "../../src/assets/images/media/file-manager/2.png";
import filemanager1 from "../../src/assets/images/media/file-manager/1.png";
import filemanager3 from "../../src/assets/images/media/file-manager/3.png";
...
const Filemanager = () => {
    ...
    return (
        <Fragment>
            <Pageheader currentpage="File Manager" activepage="File Manager" mainpage="File Manager" />
                            ...
                            <ul className="list-none files-main-nav" id="files-main-nav">
                                ...
                                <li className="mb-8">
                                    <div className="text-[#8c9097] dark:text-white/50 mb-2">
                                        <p className="mb-1"><span className="font-bold text-[.875rem]">2.42GB</span> Used</p>
                                        <p className="text-[.75rem] mb-0">52% Used - 2.58Gb free</p>
                                    </div>
                ...
                <div className={`selected-file-details ${isDetailsOpen ? 'open' : ''}`}>
                    ...
                    <div className="filemanager-file-details" id="filemanager-file-details">
                        <div className="p-4 text-center border-b border-dashed dark:border-defaultborder/10 ">
                            ...
                            <div>
                                <p className="mb-0 font-semibold text-[1rem]">IMG-09123878-SPK734.jpeg</p>
                                <p className="mb-0 text-[#8c9097] dark:text-white/50 text-[.625rem]">1.35MB | 25,Nov 2022</p>
                            </div>
                        </div>
                        <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                            <ul className="list-group">
                                <li className="list-group-item">
                                    <div>
                                        <span className="font-semibold">File Format : </span><span className="text-[.75rem] text-[#8c9097] dark:text-white/50">Jpeg</span>
                                    </div>
                                </li>
                                <li className="list-group-item">
                                    <div>
                                        <p className="font-semibold mb-0">File Description : </p>
                                        <span className="text-[.75rem] text-[#8c9097] dark:text-white/50">Product: DapZem & Co Blue Hoodie | Number: 3</span>
                                    </div>
                                </li>
                                <li className="list-group-item">
                                    <p className="font-semibold mb-0">File Location : </p>
                                    <span className="text-[.75rem] text-[#8c9097] dark:text-white/50">Storage/Products/525ddO65d/IMG-09123878-SPK734.jpeg</span>
                                </li>
                            </ul>
                        </div>
                        <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                            <p className="mb-1 font-semibold text-[.875rem]">Uploaded by :</p>
                            <div className="flex items-center p-2 mb-1">
                                ...
                                <span className="badge bg-success/10 text-success font-normal">28,Sept 2022</span>
                            </div>
                        </div>
                        <div className="p-4">
