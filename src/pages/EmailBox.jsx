...
import { Allmailsdata, Allmailsdata1 } from './mailappdata';
...
const EmailBox = () => {
	const Selectoption2 = [
		{ value: 'client@riwam.com', label: 'client@riwam.com' },
	]
	...
	const handleResize = () => {
		if (window.innerWidth <= 992) {
			...
			// Adjust visibility when not in mobile view
	...
	return (
		<Fragment>
			<Pageheader currentpage="Email Box" activepage="Extra" mainpage="Email Box" />
				...
				<div className="main-mail-container !p-2 gap-x-2 flex">
					<div className={`mail-navigation ${isMailNavigationVisible ? '!block' : ''} border dark:border-defaultborder/10`}>
						<div className="grid items-start !p-4 border-b dark:border-defaultborder/10">
							<Link to="#" className="hs-dropdown-toggle ti-btn !bg-success text-white flex items-center justify-center !font-medium" data-hs-overlay="#todo-compose"><i className="ri-add-circle-line text-[1rem] align-middle"></i>Compose Mail
							</Link>
										...
										<div className="ti-modal-body px-4">
											<div className="grid grid-cols-12 gap-6">
												<div className="xl:col-span-6 col-span-12 mb-2">
													...
													<input type="email" className="form-control" id="fromMail" defaultValue="contact@riwam.com" />
												</div>
												<div className="xl:col-span-6 col-span-12 mb-2">
						...
						<div className="flex items-start !p-4 !bg-primary">
							...
							<div className="ms-2">
								<p className="font-semibold mb-0 text-white">RIWAM User</p>
								<p className="text-white opacity-[0.7] text-[.6875rem] mb-0">user@riwam.com</p>
							</div>
						</div>
						<div>
					...
					<div className={`total-mails ${isTotalMailsVisible ? '!block' : ''} ${isTotalMailsHidden ? '!hidden' : ''} border dark:border-defaultborder/10`}>
						<div className="!p-4 flex items-center border-b dark:border-defaultborder/10">
							...
							<button aria-label="button" type="button" className="ti-btn ti-btn-icon ti-btn-light me-1 lg:hidden block total-mails-close !mb-0" onClick={() => Toggle1()}
							>
								<i className="ri-close-line"></i>
							</button>
							<div className="hs-dropdown ti-dropdown  hidden">
								...
								<ul className="hs-dropdown-menu ti-dropdown-menu hidden">
									<li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" to="#">Recent</Link></li>
									<li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" to="#">Unread</Link></li>
									<li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" to="#">Mark All Read</Link></li>
									<li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" to="#">Spam</Link></li>
									<li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" to="#">Delete All</Link></li>
								</ul>
							</div>
						</div>
						<div className="p-4">
						...
						<div className="mail-messages" id="mail-messages">
							<ul className="list-none mb-0 mail-messages-container text-defaulttextcolor text-defaultsize">
								{Allmailsdata1.map((idx) => (
									<li className={`!border-x-0 ${idx.bordercls}`} key={Math.random()}>
										<div className="flex items-start">
											...
											<div className="flex-grow">
												<Link to="#">
													<p className="mb-1 text-[0.75rem] space-x-2 me-1">
														{idx.name}
												...
												<p className="mail-msg mb-0">
													...
													<span
														className="text-[.6875rem] text-[#8c9097] dark:text-white/50 text-wrap ">{idx?.breif}
					...
					<div className={`mails-information ${isMailsInformationVisible ? '!block' : ''} border dark:border-defaultborder/10 text-defaulttextcolor text-defaultsize`}>
						<div className="mail-info-header flex flex-wrap gap-2 items-center">
							...
							<div className="responsive-mail-action-icons flex">
								<div className="hs-dropdown ti-dropdown  hidden">
									<button aria-label="button" className="!w-[2.313rem] !h-[2.313rem]  rounded-sm ti-btn-icon ti-btn-light me-2" type="button" aria-expanded="false">
										<i className="ti ti-dots-vertical"></i>
									</button>
									<ul className="hs-dropdown-menu ti-dropdown-menu hidden">
										<li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" to="#"><i className="inline-flex ri-star-line me-1 align-middle"></i>Starred</Link></li>
										<li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" to="#"><i className="inline-flex ri-inbox-archive-line me-1 align-middle"></i>Archive</Link></li>
										<li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" to="#"><i className="inline-flex ri-spam-2-line me-1 align-middle"></i>Report Spam</Link></li>
										<li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" to="#"><i className="inline-flex ri-delete-bin-line me-1 align-middle"></i>Delete</Link></li>
										<li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" to="#"><i className="inline-flex ri-reply-line me-1 align-middle"></i>Reply</Link></li>
									</ul>
								</div>
								<button aria-label="button" type="button" className="ti-btn ti-btn-icon ti-btn-light ms-1 space-x-2 rtl:space-reverse" onClick={() => Close()}>
									<i className="ri-close-line"></i>
								</button>
							</div>
						</div>
						<div className="mail-info-body  dark:!border-defaultborder/10 p-6" id="mail-info-body">
							...
							<div className="mail-attachments mb-6">
								...
								<div className="mt-2 flex items-center flex-wrap">
									<Link to="#" className="mail-attachment mb-1 me-2">
									...
									<Link to="#" className="mail-attachment">
									...
									<Link aria-label="anchor" to="#" className="!w-[2.75rem] !h-[2.75rem] ti-btn-icon ti-btn-outline-light dark:hover:!bg-light  flex items-center justify-center !rounded-md dark:!border-defaultborder/10 !ms-2 !text-[1.2rem] !text-defaulttextcolor dark:!text-defaulttextcolor/70 border">
					...
					<div className="mail-recepients border dark:border-defaultborder/10">
						...
						<SimpleBar id="mail-recepients">
							<div className="p-4 flex flex-col items-center total-mail-recepients" id="mail-recepients">
								<div className="hs-tooltip ti-main-tooltip [--placement:left]">
									<Link to="#" className="mail-recepeint-person hs-tooltip-toggle">
