...
import { Deliveryoptions, Productoptions1, Productoptions2, Productoptions3, Productoptions4, Productoptions5, Productoptions6, Productoptions7, Productoptions8, Productoptions9 } from './addproductdata';
					...
					<div className="box">
						<div className="box-body add-products !p-0">
										...
										<div className="grid grid-cols-12 gap-4">
											...
											<div className="xl:col-span-12 col-span-12 mb-4">
												<div id="product-features">
													<div className="xl:col-span-6 col-span-12">
														<label htmlFor="product-category-add" className="form-label">Delivery Method</label>
														<Select id="product-category-add" name="product-category-add" options={Deliveryoptions} className="w-full !rounded-md" isSearchable
															menuPlacement='auto' classNamePrefix="Select2" placeholder="Choose a delivery method..."
														/>
													</div>
													<div className="xl:col-span-6 col-span-12 mt-4">
														<label htmlFor="product-tags" className="form-label">Coupon Codes</label>
														<Select isMulti name="product-tags" options={Productoptions9} defaultValue={[Productoptions9[0], Productoptions9[1]]}
							...
							<div className="px-6 py-4 border-t border-dashed dark:border-defaultborder/10 sm:flex justify-end">
								<button type="button" className="ti-btn ti-btn-primary !font-medium m-1" data-hs-overlay="#todo-compose">Add Product<i className="bi bi-plus-lg ms-2"></i></button>
								<div id="todo-compose" className="hs-overlay hidden ti-modal">
									<div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
										<div className="ti-modal-content">
											<div className="ti-modal-header">
												<h6 className="modal-title text-[1rem] font-semibold" id="mail-ComposeLabel">Product added successfully!</h6>
