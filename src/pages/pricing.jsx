...
const Pricing = () => {
    return (
        <Fragment>
            <Pageheader currentpage="Plan" activepage="Pages" mainpage="Plan" />
                    ...
                    <div className="container">
                        <div className="flex justify-center mb-6">
							<nav className="bg-primary/10 p-4 rounded-md" aria-label="Tabs">
								<Link to="#" className="hs-tab-active:bg-primary hs-tab-active:text-white text-primary py-2 px-4  text-sm font-medium text-center rounded-sm hover:text-primary active" id="pm-item" data-hs-tab="#Services-monthly-pane" aria-controls="Services-monthly-pane">
									Monthly
								</Link>
								<Link to="#" className="hs-tab-active:bg-primary hs-tab-active:text-white text-primary py-2 px-4 text-sm font-medium text-center  rounded-sm hover:text-primary " id="py-item" data-hs-tab="#Services-yearly-pane" aria-controls="Services-yearly-pane">
									Yearly
								</Link>
							</nav>
						</div>
						<div className="box overflow-hidden shadow-none justify-center">
							<div className="box-body !p-0">
								<div className="tab-content dark:!border-defaultborder/10" id="myTabContent">
									<div className="tab-pane show active !p-0 dark:!border-defaultborder/10" id="Services-monthly-pane" aria-labelledby="pm-item"
										...
										<div className="grid grid-cols-12 justify-center">
													...
													<div>
														...
														<div className="py-6 flex items-center justify-center">
															...
															<div className="text-end ms-[3rem]">
																<p className="text-[1.5625rem] font-semibold mb-0">3,200 DA</p>
														...
														<ul className="list-unstyled text-center text-[0.75rem] px-4 pt-4 mb-0">
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Personalized subdomains <span className="badge bg-light text-default ms-1">5</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Varity of e-commerce templates</span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Storage Capacity <span className="badge bg-light text-default ms-1">5 GB</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Number of orders <span className="badge bg-light text-default ms-1">Unlimited</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Published products <span className="badge bg-light text-default ms-1">50</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Order Management</span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Order confirmation for free <span className="badge bg-light text-default ms-1">10</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Free custom professional email <span className="badge bg-light text-default ms-1">1</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">API Integrations for receive, organize & receive orders</span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Facebook Pixel <span className="badge bg-light text-default ms-1">3</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Live Chat Support <span className="badge bg-light text-default ms-1">24/7</span></span>
															</li>
														</ul>
													</div>
													<div className="grid">
                                                        <Link to="#" className="ti-btn ti-btn-primary !font-medium block text-center">
                                                            Get Started
                                                        </Link>
                                                    </div>
												</div>
												...
												<div className="p-6 h-full flex flex-col justify-between">
													<div>
														...
														<div className="py-6 flex items-center justify-center">
															...
															<div className="text-end ms-[3rem]">
																<p className="text-[1.5625rem] font-semibold mb-0">5,600 DA</p>
																<p className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] font-semibold mb-0">per month</p>
															</div>
														</div>
														<ul className="list-unstyled text-center text-[0.75rem] px-4 pt-4 mb-0">
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Personalized subdomains <span className="badge bg-light text-default ms-1">10</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Varity of e-commerce templates</span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Storage Capacity <span className="badge bg-light text-default ms-1">10 GB</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Number of orders <span className="badge bg-light text-default ms-1">Unlimited</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Published products <span className="badge bg-light text-default ms-1">100</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Order Management</span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Order confirmation for free <span className="badge bg-light text-default ms-1">20</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Free custom professional email <span className="badge bg-light text-default ms-1">3</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">API Integrations for receive, organize & receive orders</span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Facebook Pixel <span className="badge bg-light text-default ms-1">7</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Live Chat Support <span className="badge bg-light text-default ms-1">24/7</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Search engine optimization (SEO)</span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Inventory management </span>
															</li>
														</ul>
													</div>
													<div className="grid">
											...
											<div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12">
												<div className="p-6 pricing-offer overflow-hidden h-full flex flex-col justify-between">
													<div>
														...
														<div className="py-6 flex items-center justify-center">
															...
															<div className="text-end ms-[3rem]">
																<p className="text-[1.5625rem] font-semibold mb-0 !text-primary">8,800 DA</p>
																<p className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] font-semibold mb-0">per month</p>
															</div>
														</div>
														<ul className="list-unstyled text-center text-[0.75rem] px-4 pt-4 mb-0">
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Personalized subdomains <span className="badge bg-light text-default ms-1">15</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Varity of e-commerce templates</span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Storage Capacity <span className="badge bg-light text-default ms-1">Unlimited</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Number of orders <span className="badge bg-light text-default ms-1">Unlimited</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Published products <span className="badge bg-light text-default ms-1">Unlimited</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Order Management</span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Order confirmation for free <span className="badge bg-light text-default ms-1">30</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Free custom professional email <span className="badge bg-light text-default ms-1">5</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">API Integrations for receive, organize & receive orders</span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Facebook Pixel <span className="badge bg-light text-default ms-1">10</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Live Chat Support <span className="badge bg-light text-default ms-1">24/7</span></span>
															</li>
															...
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Stock Inventory Management </span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Full Integrated with the RIWAM Ecosystem </span>
															</li>
														</ul>
													</div>
													<div className="grid">
									...
									<div className="tab-pane !p-0 border dark:border-defaultborder/10 hidden" id="Services-yearly-pane" aria-labelledby="py-item"
										role="tabpanel" tabIndex={0}>
												...
												<div className="p-6 h-full flex flex-col justify-between">
													<div>
														...
														<div className="py-6 flex items-center justify-center">
															...
															<div className="text-end ms-[3rem]">
																<p className="text-[1.5625rem] font-semibold mb-0">35,200 DA</p>
														...
														<ul className="list-unstyled text-center text-[0.75rem] px-4 pt-4 mb-0">
															...
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50"> Pixel <span className="badge bg-light text-default ms-1">3</span></span>
															</li>
															<li className="mb-4">
																<span className="text-[#8c9097] dark:text-white/50">Live Chat Support <span className="badge bg-light text-default ms-1">24/7</span></span>
															</li>
												...
												<div className="p-6 h-full flex flex-col justify-between">
													<div>
														...
														<div className="py-6 flex items-center justify-center">
															...
															<div className="text-end ms-[3rem]">
																<p className="text-[1.5625rem] font-semibold mb-0">61,600 DA</p>
																<p className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] font-semibold mb-0">per year</p>
															</div>
														</div>
														<ul className="list-unstyled text-center text-[0.75rem] px-4 pt-4 mb-0">
												...
												<div className="p-6 pricing-offer overflow-hidden h-full flex flex-col justify-between">
													<div>
														...
														<div className="py-6 flex items-center justify-center">
															...
															<div className="text-end ms-[3rem]">
																<p className="text-[1.5625rem] font-semibold mb-0 !text-primary">96,800 DZD</p>
																<p className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] font-semibold mb-0">per month</p>
															</div>
														</div>
														<ul className="list-unstyled text-center text-[0.75rem] px-4 pt-4 mb-0">
